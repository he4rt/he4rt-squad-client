  ...
  <div id="discord" class="flex items-center w-full h-60">
    ...
    <div v-motion="{
      ...
      <div class="text-3xl">
        ...
        <p class="w-3/4 mt-5 text-h-gray leading-6 md:leading-8 hidden md:flex">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc congue, velit sed scelerisque consequat, elit sem consequat erat, quis mollis nibh lacus eget mauris.</p>
      </div>
    </div>
    <div v-motion="{
      initial: {
