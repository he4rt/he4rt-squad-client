<template>
  <div
    ...
    class="w-full bg-h-dark-two rounded box-border overflow-y-auto text-justify flex items-center"
  >
    <div class="p-5">
      ...
      <div class="flex items-center">
        ...
        <div class="flex items-center justify-between text-h-gray mr-15">
          <IconClock />
          <p>{{ time }} hrs</p>
        </div>
        <div class="flex items-center">
