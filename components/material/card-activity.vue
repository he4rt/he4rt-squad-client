<template>
    <div :class="[color === 'done' ? 'border-l-solid border-green-500 ' : '',
        ...
        <div class="grow  p-5 ">
            ...
            <div class="flex items-center justify-between	">
                ...
                <div class="flex items-center ">
                    <p v-if="color === 'done'" class="text-green-500">
                        <IconCheck class="w-4 h-4 " /> Finalizado
                    </p>
                    <p v-else-if="color === 'doing'" class="text-yellow-400">
                        <IconClose class="w-4 h-4 " /> Em andamento
                    </p>
                    <p v-else-if="color === 'unavailable'" class="text-red-600">
                        <IconExclamation class="w-4 h-4  " />Indisponível
                    </p>
                </div>
                <div  class="flex items-center gap-2">
                    <IconStar v-if="(typeof starAmount === 'number')" class="w-5 h-5 text-yellow-400" />
                    <div v-else="(!starAmount)" class="text-h-gray">
                        <IconStar  class="w-5 h-5 text-h-gray" /> Avaliar
                    </div>
